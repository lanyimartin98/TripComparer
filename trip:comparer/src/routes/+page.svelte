...
<article class="bg-cyan-500 p-4">
	{#if expanded}
		<p class="lg:line-clamp-none line-clamp-none">
			...
			donating to the API makers FlightLabs and Carbon Interface, who have provided the underlying
	...
	{:else}
		<p class="lg:line-clamp-none line-clamp-3">
			This application is designed to measure the carbon efficiency of different travel options. By
			providing data on the carbon footprint of each option, you can make more informed decisions
			about how to travel in a way that minimizes your impact on the environment. Before you get
			started, I want to disclose that this is just a part of my developer portfolio and not an
	...
	{/if}
	<button class="lg:hidden text-xs w-full hover:scale-100 hover:opacity-50" on:click={expand}>
		{#if expanded}
			Show less
		{:else}
			Show more
	...
	<p>
		You can find more information in the applications Github repository! ps.: The introduction was
		actually generated by ChatGPT, just to throw in some fancy AI stuff...
	</p>
</article>
